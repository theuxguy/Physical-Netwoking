...
export default function AD3Block({ onClick, isClickable = false, onBLDClick, isHovered = false }: AD3BlockProps) {
  ...
  return (
    ...
    >
      <div 
        aria-hidden="true" 
        className="absolute border border-[rgba(222,128,17,0.6)] dark:border-[rgba(255,152,30,0.7)] border-solid inset-0 pointer-events-none rounded-[8px]"
        style={{
          backgroundColor: isHovered ? 'rgba(222, 128, 17, 0.15)' : 'transparent',
        }}
      />
