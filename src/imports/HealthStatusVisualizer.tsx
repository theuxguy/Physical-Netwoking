...
export default function Group() {
  return (
    <div className="relative size-full">
      <div className="absolute flex inset-[17.81%_2.31%_17.81%_1.54%] items-center justify-center">
      ...
      <div className="absolute contents inset-[45.21%_2.35%_20.38%_0]">
        <div className="absolute content-stretch flex gap-[0.5px] inset-[45.21%_2.35%_20.38%_0] items-end">
          ...
          <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
            <div className="col-1 content-stretch flex gap-[0.5px] items-end justify-center ml-0 mt-0 relative row-1">
              <div className="content-stretch flex gap-px items-end justify-center relative shrink-0">
                <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
                  <Helper />
                </div>
                <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="absolute inset-[1.37%_2.99%_0_95.9%] rounded-[5px]">
