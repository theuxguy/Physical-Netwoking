...
export default function Frame() {
  return (
    <div className="bg-[rgba(228,238,224,0.8)] content-stretch flex flex-col gap-[4px] items-start p-[12px] relative rounded-[8px] size-full">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-full not-italic relative shrink-0 text-[#161513] text-[11px] w-[min-content]" style={{ fontFeatureSettings: "'lnum', 'tnum'" }}>
        Region: Dubai
      </p>
