...
function TableHelper4({ children, additionalClassNames = "" }: React.PropsWithChildren<TableHelper4Props>) {
  return (
    <Wrapper additionalClassNames={additionalClassNames}>
      <div className="leading-[normal] not-italic relative shrink-0 text-[#222] text-[0px] text-right whitespace-nowrap whitespace-pre">{children}</div>
    </Wrapper>
  );
}
...
function TableHelper3({ children, additionalClassNames = "" }: React.PropsWithChildren<TableHelper3Props>) {
  return (
    <Wrapper additionalClassNames={additionalClassNames}>
      <div className="leading-[0] not-italic relative shrink-0 text-[#222] text-[0px] text-right whitespace-nowrap whitespace-pre">{children}</div>
    </Wrapper>
  );
}
    ...
    <div className="bg-[#eee] relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex gap-[10px] items-center justify-end px-[25px] py-[10px] relative w-full">
          <p className="[text-decoration-skip-ink:none] decoration-solid font-normal leading-[normal] not-italic relative shrink-0 text-[#00688c] text-[14px] underline whitespace-nowrap">{text}</p>
          <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
            <div className="bg-[#227e9e] col-1 content-stretch flex items-center justify-center ml-0 mt-0 px-[2.5px] relative rounded-[3px] row-1">
              ...
              <p className="font-normal leading-[12px] not-italic relative shrink-0 text-[9px] text-center text-white whitespace-nowrap">{text1}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="content-stretch flex items-start relative size-full">
        <div className="content-stretch flex items-start relative shrink-0 w-[145px]">
          ...
          <div className="content-stretch flex flex-[1_0_0] flex-col h-[447px] items-start min-h-px min-w-px relative">
            <Wrapper1>
              <p className="font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">Region</p>
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col h-[447px] items-start min-h-px min-w-px relative">
          ...
          <TableHelper3 additionalClassNames="bg-[rgba(80,130,35,0.4)]">
            <p className={`leading-[normal] mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>25.1 m/s</p>
            <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[12px]" : undefined}>
              ...
              <span className={`leading-[normal] ${isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium not-italic' : "text-[11px]"}`}>{isRealmAndCrossRegionLatencyAndPacketLoss ? "  26.3 %" : "26.3 %"}</span>
            </p>
          </TableHelper3>
          <TableHelper2 additionalClassNames="bg-[rgba(255,255,255,0.2)] h-[41px]" />
          <TableHelper2 additionalClassNames="bg-white h-[41px]" />
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col h-[447px] items-start min-h-px min-w-px relative">
          ...
          <Wrapper additionalClassNames="bg-[#b9cda7]">
            <div className={`not-italic relative shrink-0 text-[#222] text-[0px] text-right whitespace-nowrap whitespace-pre ${isRealmAndCrossRegionLatencyAndPacketLoss ? "leading-[normal]" : "leading-[0]"}`}>
              <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium leading-[normal] text-[12px]'}`}>25.1 m/s</p>
              <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : undefined}>
          ...
          <TableHelper4 additionalClassNames="bg-[#b9cda7]">
            <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>25.1 m/s</p>
            <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>{`   26.3 %`}</p>
          </TableHelper4>
        </div>
        <div className="content-stretch flex flex-[1_0_0] flex-col h-[447px] items-start min-h-px min-w-px relative">
          <div aria-hidden="true" className="absolute border-[#b9b9b9] border-b border-solid border-t inset-[-1px_0] pointer-events-none" />
          ...
          <TableHelper4 additionalClassNames="bg-[rgba(222,128,17,0.4)]">
            <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>125.1 m/s</p>
            <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>{`   126.3 %`}</p>
          </TableHelper4>
          <TableHelper3 additionalClassNames="bg-[#efb1a8]">
            <p className={`leading-[normal] mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>155.1 m/s</p>
            <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>
              <span className="leading-[normal]">{`  `}</span>
              <span className="leading-[normal] text-[#222]">{` 176.3 %`}</span>
            </p>
          </TableHelper3>
          <Wrapper additionalClassNames="bg-[rgba(214,59,37,0.4)]">
            <div className={`not-italic relative shrink-0 text-[#222] text-[0px] text-right whitespace-nowrap whitespace-pre ${isRealmAndCrossRegionLatencyAndPacketLoss ? "leading-[0]" : "leading-[normal]"}`}>
              <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "leading-[normal] text-[11px]" : 'font-medium text-[12px]'}`}>{isRealmAndCrossRegionLatencyAndPacketLoss ? "155.1 m/s" : "156.1 m/s"}</p>
              <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col h-[447px] items-start min-h-px min-w-px relative">
          ...
          <Wrapper additionalClassNames="bg-[rgba(214,59,37,0.4)]">
            <div className={`not-italic relative shrink-0 text-[#222] text-[0px] text-right whitespace-nowrap whitespace-pre ${isRealmAndCrossRegionLatencyAndPacketLoss ? "leading-[0]" : "leading-[normal]"}`}>
              <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "leading-[normal] text-[11px]" : 'font-medium text-[12px]'}`}>155.1 m/s</p>
              <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>
                {isRealmAndCrossRegionLatencyAndLatency && "   176.3 %"}
                {isRealmAndCrossRegionLatencyAndPacketLoss && (
                  <>
          ...
          <Wrapper additionalClassNames="bg-[#b9cda7]">
            <div className={`leading-[normal] not-italic relative shrink-0 text-[#222] text-[0px] text-right ${isRealmAndCrossRegionLatencyAndPacketLoss ? "w-[53px] whitespace-pre-wrap" : "whitespace-nowrap whitespace-pre"}`}>
              <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>25.1 m/s</p>
              <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>{`   26.3 %`}</p>
            </div>
          </Wrapper>
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col h-[447px] items-start min-h-px min-w-px relative">
          ...
          <TableHelper4 additionalClassNames="bg-[#f2cca0]">
            <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>125.1 m/s</p>
            <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>{isRealmAndCrossRegionLatencyAndPacketLoss ? "   126.3 %" : "   26.3 %"}</p>
          </TableHelper4>
          <TableHelper4 additionalClassNames="bg-[rgba(222,128,17,0.4)]">
            <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>125.1 m/s</p>
            <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>{`   126.3 %`}</p>
          ...
          <Wrapper additionalClassNames="bg-[#b9cda7]">
            <div className={`leading-[normal] not-italic relative shrink-0 text-[#222] text-[0px] whitespace-nowrap whitespace-pre ${isRealmAndCrossRegionLatencyAndPacketLoss ? "" : "text-right"}`}>
              <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>25.1 m/s</p>
              <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>{`   26.3 %`}</p>
            </div>
          </Wrapper>
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col h-[447px] items-start min-h-px min-w-px relative">
          ...
          <Wrapper additionalClassNames="bg-[#b9cda7]">
            <div className={`not-italic relative shrink-0 text-[#222] text-[0px] text-right whitespace-nowrap whitespace-pre ${isRealmAndCrossRegionLatencyAndPacketLoss ? "leading-[0] text-[11px]" : "leading-[normal]"}`}>
              <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "" : 'font-medium text-[12px]'}`}>
                {isRealmAndCrossRegionLatencyAndLatency && "25.1 m/s"}
                {isRealmAndCrossRegionLatencyAndPacketLoss && (
                  <>
                    <span className="leading-[normal] not-italic">25.1</span>
                    <span className="leading-[normal]">{` m/s`}</span>
                  </>
                )}
              </p>
              <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium leading-[normal]' : "text-[11px]"}>{`   26.3 %`}</p>
            </div>
          </Wrapper>
          <TableHelper4 additionalClassNames="bg-[#b9cda7]">
            <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>25.1 m/s</p>
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col h-[447px] items-start min-h-px min-w-px relative">
          ...
          <TableHelper4 additionalClassNames="bg-[#b9cda7]">
            <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>25.1 m/s</p>
            <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>{isRealmAndCrossRegionLatencyAndPacketLoss ? "   26.3 %" : "   26.3%"}</p>
          </TableHelper4>
          <TableHelper4 additionalClassNames="bg-[#b9cda7]">
            <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>25.1 m/s</p>
            <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium text-[12px]' : "text-[11px]"}>{`   26.3 %`}</p>
          ...
          <Wrapper additionalClassNames="bg-[rgba(222,128,17,0.4)]">
            <div className={`leading-[normal] not-italic relative shrink-0 text-[#222] text-[0px] text-right whitespace-nowrap whitespace-pre ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[12px]" : ""}`}>
              <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "" : 'font-medium text-[12px]'}`}>125.1 m/s</p>
              <p className={isRealmAndCrossRegionLatencyAndPacketLoss ? 'font-medium' : "text-[11px]"}>{`   126.3 %`}</p>
            </div>
          </Wrapper>
          <TableHelper4 additionalClassNames="bg-[#b9cda7]">
            <p className={`mb-0 ${isRealmAndCrossRegionLatencyAndPacketLoss ? "text-[11px]" : 'font-medium text-[12px]'}`}>25.1 m/s</p>
