    ...
    <div className="relative size-full" data-name="Prompt/Info">
      <div className="absolute bg-white content-stretch flex inset-0 items-start p-[10px] rounded-[3px]" data-name="Tooltip">
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
          <div className="font-normal leading-[0] not-italic relative shrink-0 text-[#161513] text-[11px] w-full whitespace-pre-wrap" style={{ fontFeatureSettings: "'lnum', 'tnum'" }}>
            <p className="mb-0">
              <span className="leading-[18px]">{`AD-2 availability is `}</span>
              <span className="font-semibold leading-[18px] not-italic text-[#d63b25]">Critical</span>
